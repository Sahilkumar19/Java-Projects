...
public class SortingAlgosImplementation {
    public static void main(String[] args) {
        int[] arr={4,7,7,1,2,3};
        System.out.println("array sorted using bubble sort: "+" "+Arrays.toString(BubbleSort(arr)));
        System.out.println("array sorted using insertion sort: "+" "+Arrays.toString(InsertionSort(arr)));
        System.out.println("array sorted using selection sort: "+" "+Arrays.toString(SelectionSort(arr)));
        int s=0;
        int e=arr.length-1;
        int[] ans=QuickSort(arr,s,e);
        System.out.println("array sorted using quick sort: "+" "+Arrays.toString(ans));
        int[] sortedArray = MergeSort(arr, s, e);
